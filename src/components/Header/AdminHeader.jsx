      ...
      <div className="navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <a className="nav-link mx-2" href="/admin" style={{ color: '#E0E1ED', fontSize: 17 }}>Dashboard</a>
          </li>
          <li className="nav-item">
            <a className="nav-link mx-2" href="/admin/table" style={{ color: '#E0E1ED', fontSize: 17 }}>Table</a>
          </li>
        </ul>
      </div>
    </nav>
